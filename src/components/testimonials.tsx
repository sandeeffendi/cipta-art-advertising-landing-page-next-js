            ...
            <div className="py-16 md:py-32">
                <div className="mx-auto max-w-6xl px-6">
                    <div className="text-center">
                        <h2 className="text-title text-3xl font-semibold">Hear from Our Happy Clients</h2>
                        <p className="text-body mt-6">Kepuasan Kamu adalah motivasi kami, dan kesuksesan Kamu adalah tujuan kami.</p>
                    </div>
